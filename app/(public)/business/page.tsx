...
const MarketplaceMap = dynamic(() => import("../../marketplace/components/MarketplaceMap"), {
  ssr: false,
  loading: () => (
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 -mt-16 relative z-10">
        ...
        {error && !loading && (
          <div className="bg-rose-50 border border-rose-200 rounded-2xl p-6 text-center text-rose-700 max-w-2xl mx-auto">
            <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="mx-auto mb-3 opacity-80"><circle cx="12" cy="12" r="10" /><line x1="12" x2="12" /><line x1="12" x2="12.01" y1="16" y2="16" /></svg>
